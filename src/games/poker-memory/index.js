...
export const PokerMemory = {
    ...
    renderConfig() {
      ...
      <div class="card-game" style="position: relative; flex: 1; display: flex; flex-direction: column; justify-content: center; align-items: center;">
        <button type="button" id="back-to-games-btn" class="back-btn" style="position: absolute; top: 1rem; left: 1rem; z-index: 2;">← Back to Games</button>
    ...
    `;
        ...
        this.pageContent.querySelector('#back-to-games-btn').onclick = () => {
