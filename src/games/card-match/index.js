...
export function renderCardMatch(appEl) {
    ...
    function render() {
        ...
        const gameWrapper = createElement('div', { className: 'card-game', style: 'position: relative; max-width: 800px; margin: 0 auto;' });

        // Back button
        gameWrapper.appendChild(createElement('button', {
            type: 'button',
            className: 'back-btn',
            style: 'position: absolute; top: 1rem; left: 1rem; z-index: 2;',
            textContent: '← Back to Games',
